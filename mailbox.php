...
<nav class="nav1">
    ...
    <div class="container add">
        <div class="row">
            ...
            <hr />
            <h4 class="center" style="color: #ff4f4f;">All messages</h4>
            <hr />
            </div>
        ...
        <thead>
          ...
          <tr>
              ...
              <th data-field="price">Read</th>
          </tr>
          
        </thead>
        <tbody>
        
        <?php $query_Events = "SELECT * FROM messages ORDER BY `id` ASC";
         ...
         ?>
          <tr>
            ...
            <td style="color: white;"><?php echo $title; ?></td>
              <td><a href="readmessage.php?id=<?php echo $id; ?>"><input type="submit" style="font-size: 10px;" name="read" value="+" class="red"></a></td>
