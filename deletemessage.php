...
<nav class="nav1">
    ...
    <div class="container add">
        <div class="row">
            ...
            <br />
            <hr />
               	<h3 class="hide-on-med-and-down" style="color: white;">ПОТВЪРДЕТЕ ПРЕМАХВАНЕТО НА <br /> "<?php echo $title; ?>"</h3><br />
               	<h5 class="hide-on-large-only" style="color: white;">ПОТВЪРДЕТЕ ПРЕМАХВАНЕТО НА <br /> "<?php echo $title; ?>"</h5><hr /><br />
               	<form method="post" action="deletemessage.php?id=<?php echo $id; ?>">
               	...
               	<a href="mailbox.php"><input style="width: 20%; height: 35px; border: 3px solid white; font-size: 15px; color: white;" type="submit" value="Back" ></a>
               			<br /><br /><hr /><br />
               			<br />
               		<?php
               			if(isset($_POST['delete'])){
               				$sqll = "DELETE FROM messages WHERE id = '$id' ";
