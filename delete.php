<?php 
 ...
 ?> 
<?php
     $query_select = "SELECT * FROM `places` WHERE id = '$id' LIMIT 1";
        ...
        <div class="row">
            ...
            <hr />
               	...
               	<form method="post" action="delete.php?id=<?php echo $id; ?>">
               		<input style="width: 80%; height: 50px; border: 3px solid white; font-size: 20px; color: white;" type="submit" value="DELETE" name="delete">
               		
               	</form>
               	<a href="admincontrol.php"><input style="width: 20%; height: 35px; border: 3px solid white; font-size: 15px; color: white;" type="submit" value="Back" ></a>
               			<br /><br /><hr /><br />
               		<?php
               			if(isset($_POST['delete'])){
               				$sqll = "DELETE FROM places WHERE id = '$id' ";
