<?php 
 ...
 ?> 
<?php
     $query_select = "SELECT * FROM `categories` WHERE id = '$id' LIMIT 1";
    ...
    <div class="container add">
        <div class="row">
            ...
            <hr />
               	...
               	<form method="post" action="deletecategory.php?id=<?php echo $id; ?>">
               	...
               	<a href="controller.php"><input style="width: 20%; height: 35px; border: 3px solid white; font-size: 15px; color: white;" type="submit" value="Back" ></a>
               		...
               		<?php
               			if(isset($_POST['delete'])){
               				$sqll = "DELETE FROM categories WHERE id = '$id' ";
